			        ...
			        <Panel id="collapsible-panel-example-2" style={set_visibility}>
			          ...
			          <Panel.Collapse>
			            <Panel.Body>
							...
							Μέτα πατάμε και κουμπί Convert και οι υπότιτλοι εμφανίζονται στο πεδίο Conveted Subtitles .
							Όταν είναι έτυμοι τούς αντιγραφούμε από το   Conveted Subtitles  κάνοντας κλικ σε οποιοδήποτε σημείο στους υποτίτλους και μετά πατώντας CTRL+A.
			            </Panel.Body>
			          </Panel.Collapse>
			        </Panel>
